...
// SessionCache provides TTL-based session-to-auth bindings with automatic cleanup.
...
// Get retrieves the auth ID bound to a session without refreshing TTL.
...
// GetAndRefresh retrieves the auth ID and refreshes TTL on hit.
...
// Set binds a session to an auth ID.
