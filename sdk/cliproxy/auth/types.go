...
type Auth struct {
	...
	// LastResult stores the last observed execution/probe result, including successful ones.
...
// ResultSnapshot captures the latest request/probe outcome for management display.
type ResultSnapshot struct {
	// Success marks whether the last observed request completed successfully.
	Success bool `json:"success"`
	// StatusCode carries the upstream HTTP-like status code when known.
	StatusCode int `json:"status_code,omitempty"`
	// Code is an optional machine readable error/result code.
	Code string `json:"code,omitempty"`
	// Message is an optional human readable summary for the result.
	Message string `json:"message,omitempty"`
	// Retryable indicates whether retrying may recover from this result automatically.
	Retryable bool `json:"retryable,omitempty"`
	// UpdatedAt records when this result snapshot was written.
	UpdatedAt time.Time `json:"updated_at"`
}
...
func (a *Auth) Clone() *Auth {
	...
	if a.LastResult != nil {
		copyAuth.LastResult = a.LastResult.Clone()
	}
...
// Clone duplicates a result snapshot.
